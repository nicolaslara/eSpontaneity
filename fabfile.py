...
env.hosts = ['espontaneity.dev.espontaneity.com']
env.root = '/opt/webapps/espontaneity'
env.proj_root = env.root + '/src/espontaneity'
...
def clone():
    ...
    with cd('%s/espontaneity/conf/local' % env.proj_root):
